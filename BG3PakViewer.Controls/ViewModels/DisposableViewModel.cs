...
/// <list type="bullet">
/// <item><see cref="Dispose(bool)"/> for synchronous cleanup (the default
/// <see cref="DisposeAsyncCore"/> bridges the async path into it), or</item>
/// <item><see cref="DisposeAsyncCore()"/> for true asynchronous cleanup
/// (synchronous <see cref="Dispose()"/> then performs no managed cleanup).</item>
/// </list>
